...
func TestValidatePRTitle(t *testing.T) {
	tests := []struct {
		...
		{"compound linear prefix", "LIN-ROU-586: feat: widen along-route search window", false},
		{"three-segment prefix", "LIN-MY1-TEAM-42: fix(core): resolve label scope", false},
		{"compound prefix without type", "LIN-ROU-586: widen search window", true},
