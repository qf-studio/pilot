...
**Current Version:** v2.239.0 (daemon on local build `v2.238.1-11-g6e60eb4b` = origin/main incl. full hardening set; rides next 16:00 train) | full status in `.agent/system/FEATURE-MATRIX.md`
