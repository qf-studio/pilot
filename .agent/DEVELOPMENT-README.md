...
| **P1** | **CI-fix continuation drops original commits** ([#5348](https://github.com/qf-studio/pilot/issues/5348), dispatched 09-07) | fix run rebuilds the branch from main when the failed PR branch was deleted; original issue falsely superseded (pilot-console #275 incident). Pitfall `ci-fix-continuation-rebuilds-branch-from-main-drops-original-commits`. |
