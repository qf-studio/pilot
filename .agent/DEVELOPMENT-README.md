...
**Current Version:** box runs **v2.271.4** (09-01 train, self-upgraded; metric-verified via `pilot-board`). Prior out-of-band rebuild context (08-26, #5235/#5237) lives in the archived marker `2026-08-26_day-close-s5-opened-s4-corrected.md`.
