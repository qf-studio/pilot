...
**Current Version:** box build `v2.241.2-27-gea7c0e0f` (deployed 07-18 13:29Z from main) — **daemon runs on AWS** (`i-0e0c1ca34e7b561f9`, TASK-409; ops via `pilot-aws` skill; NO local daemon) | full status in `.agent/system/FEATURE-MATRIX.md`
