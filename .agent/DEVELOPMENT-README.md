...
**Current Version:** box runs **v2.276.1** (released 2026-09-14 14:11Z; carries the acceptance-evidence gate #5439/#5440, the argv-exec + redaction pin #5443, and auto-preserve escalation #5446). Previous: **v2.276.0** (09-13 14:29Z), **v2.275.0** (09-10). Prior context in the archived markers.
...
**Recent (Aug 25 – Sep 15 2026; detail lives in `system/saas-roadmap.md`, `system/approval-architecture-roadmap.md`, `tasks/archive/`, and git log — do not re-grow this block, replace it):**
