...
| Priority | Topic | Why |
|----------|-------|-----|
| P0 | **Runtime self-verification** ([TASK-379](tasks/TASK-379-runtime-self-verification.md)) | 🚧 V1–V3+V5 ✅ shipped; V4/V6/V7 dispatched; **V8 canary dispatched 2026-07-04 ([#3862](https://github.com/qf-studio/pilot/issues/3862))** — sandbox `qf-studio/pilot-canary-sandbox` created + scaffolded, `projects:` config entry + `CANARY_GH_TOKEN` secret in place. Makes the deployed system self-verifying: doctor/`/ready` live auth probes, fail-loud degraded paths, `execution_events` stage ledger, scheduled end-to-end canary. |
