...
**Current Version:** box build `v2.242.0-4-g1a7eea45` (deployed 07-20 09:32Z from main; release v2.242.0 cut by train 07-19 14:04Z) — **daemon runs on AWS** (`i-0e0c1ca34e7b561f9`, TASK-409; ops via `pilot-aws` skill; NO local daemon; binary at `/var/lib/pilot/bin/pilot`, `/usr/local/bin/pilot` is a symlink) | full status in `.agent/system/FEATURE-MATRIX.md`
