...
**Live verification**: 🔴 **EXERCISED 2026-06-10 on GH-3535 (TASK-285) — MIXED, 2 of 4 checks FAILED.** The v2.183.0 daemon decomposed #3535 → #3536 (memory/CLI, shipped via PR #3539 ✅ base=main, in-scope) + #3537 (TUI wiring) + #3538 (hallucinated OAuth child, recurring junk). Checklist results:
