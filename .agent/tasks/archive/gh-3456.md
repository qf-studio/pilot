...
**Created:** 2026-06-05
**Status:** ✅ MERGED & RELEASED — PR [#3459](https://github.com/qf-studio/pilot/pull/3459) merged to `main` 2026-06-08 (merge `07467a9d`); issue #3456 closed/completed; first shipped in **v2.169.0**, in every release since (current v2.186.8). Branch `pilot/GH-3456` deleted post-merge.
