...
**Status**: 🚀 ACTIVE — 12 of 17 legs MERGED + REVIEWED, all APPROVE (console PR#119/121/123/125 · ui PR#51/53/55/57/59/61/63/65). Console chain DONE except founder-gated CON-5. t8 dispatched: UI-9 onboarding (ui#66). Remaining: UI-10..12 + CON-5. Side-filed: pilot#4869 (journal-close on external merge — history rows stuck at awaiting_approval).
**Created**: 2026-08-14
...
| UI-9 | Onboarding v1 (signup+org merge, get-started checklist) | M/L | — (slack leg) | 🚀 [#66](https://github.com/qf-studio/pilot-console-ui/issues/66) |
...
- UI-9: ui#66 (2026-08-14) — signup+org one-submit (kills OrgCreateView), derived 4-step checklist (org·GitHub·Anthropic·plan; billing-gate-off renders not-required), provision auto-fire w/ 412/402 reuse, finish-line w/ **onboarding-scoped bounded poll** (PR#63 note landed here by design), "Ship your first ticket" card. Guard rework flagged ⚠ per program risk #5 (onboarding no longer bounces when org exists; full guard-matrix tests ordered)
