...
| UI-12 | Mobile v1 (media queries + 4-tab bar; 5 frames) | M/L 🔒 | all surfaces | 🔄 **false delivery** (PR#76 → stack branch, pilot#4872) proved self-sealing: poller re-marks #71 done on PR#76's merged flag (symptom 2 on the bug). [#71](https://github.com/qf-studio/pilot-console-ui/issues/71) closed; re-land carried by fresh [#83](https://github.com/qf-studio/pilot-console-ui/issues/83) (restore branch + #79-route adaptation + #78 folded in) — **running 14:38Z** |
