...
| UI-9 | Onboarding v1 (signup+org merge, get-started checklist) | M/L | — (slack leg) | ✅ PR#67 merged 08-15; fast-follow [#69](https://github.com/qf-studio/pilot-console-ui/issues/69) retry armed (PR#73 closed) |
| UI-10 | Settings v1 (rename / members read-only / plan+past_due / danger zone) | M/L | CON-4 (portal btn: CON-5) | ✅ retry PR#79 merged 08-15 12:02Z, post-merge review APPROVE-w-defects (view tests + note-extraction dropped vs closed #72) → fast-follow [#80](https://github.com/qf-studio/pilot-console-ui/issues/80) |
...
| UI-12 | Mobile v1 (media queries + 4-tab bar; 5 frames) | M/L 🔒 | all surfaces | ❌ **false delivery** — PR#76 merged into stack branch, never main (pilot#4872). Content at `restore/GH-71-mobile`; [#71](https://github.com/qf-studio/pilot-console-ui/issues/71) reopened, retry armed; [#78](https://github.com/qf-studio/pilot-console-ui/issues/78) closed-superseded (folds into re-land) |
