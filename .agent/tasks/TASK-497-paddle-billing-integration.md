...
### L4 — console: customer portal session endpoint — 🚀 DISPATCHED 2026-09-13 → [console#305](https://github.com/qf-studio/pilot-console/issues/305) (`pilot` + `no-decompose`)
