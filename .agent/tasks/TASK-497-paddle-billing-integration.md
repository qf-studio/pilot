...
- Pilot issues: L1 console#297 → PR#298 (merged) · L1 follow-up console#299 · L2 console#300 · L3 ui#156 → PR#157 (merged) · L3 follow-up ui#158 → PR#159 (superseded) → ui#160 · **L4 console#305** · executor evidence-gate side quest pilot#5435 → PR#5436 (closed) → #5437/#5438 → PR#5439/#5440 (merged) → #5441 (declined) → #5442

---

**Last Updated**: 2026-09-13 (rev 4: L4 dispatched as console#305 with three D5 deltas; pilot#5441 declined → #5442; rev 3: L7 go-live leg adapted from Paddle's prompt; D2 source-IP allowlist from `GET /ips`; rev 2: Paddle plugin installed; D4 → sweep + grace + resync; founder checklist shrunk)
