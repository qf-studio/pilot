...
**Created**: 2026-07-22 · **Status**: ✅ ALL MERGED (verified 2026-07-23) — [#4501](https://github.com/qf-studio/pilot/issues/4501)→PR #4504 (16:37Z) / [#4502](https://github.com/qf-studio/pilot/issues/4502)→PR #4505 (17:03Z) / [#4503](https://github.com/qf-studio/pilot/issues/4503)→PR #4506 (17:43Z, held for scope-release schedule then merged). Ride the 2026-07-23 16:00 Berlin train; archive this doc once the released daemon proves the class fixed (no false stall-kills on a long high-effort turn).
