...
| OAuth2 provider integration | ✅ | gateway | - | `auth.type=oauth` | GitHub/Google/Microsoft/Generic; /auth/login + /auth/callback + /auth/logout; session tokens (v2.110.0, GH-2510) |
