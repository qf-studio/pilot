...
|----------|----------|--------|
| **macOS** (Intel + Apple Silicon) | [Pilot-Desktop-macOS-universal.dmg](https://github.com/qf-studio/pilot/releases/latest/download/Pilot-Desktop-macOS-universal.dmg) | DMG (recommended) |
| **macOS** | [Pilot-Desktop-macOS-universal.zip](https://github.com/qf-studio/pilot/releases/latest/download/Pilot-Desktop-macOS-universal.zip) | ZIP |
| **Windows** (amd64) | [Pilot-Desktop-Windows-amd64.zip](https://github.com/qf-studio/pilot/releases/latest/download/Pilot-Desktop-Windows-amd64.zip) | ZIP |
| **Linux** (amd64) | [Pilot-Desktop-Linux-amd64.tar.gz](https://github.com/qf-studio/pilot/releases/latest/download/Pilot-Desktop-Linux-amd64.tar.gz) | tar.gz |
...
```bash
make desktop-package VERSION=v2.151.0
```

Produces `bin/Pilot-macOS-v2.151.0.zip`.
