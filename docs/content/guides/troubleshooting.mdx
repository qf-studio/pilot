...
1. **Initialize context intelligence** — Pilot auto-creates `.agent/` on first task; see [Context Intelligence setup](/navigator/setup) to tailor the index and docs
...
1. Check existing issues: [github.com/qf-studio/pilot/issues](https://github.com/qf-studio/pilot/issues)
