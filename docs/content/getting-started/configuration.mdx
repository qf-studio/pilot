...
| `decompose.enabled` | bool | `false` | Auto-decompose complex tasks into subtasks ([Epic Decomposition](/features/epic-decomposition)) |
...
[Claude Code hooks →](/features/hooks)
