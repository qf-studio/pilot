...
<Callout type="info">
Full knowledge graph wiring for execution prompts is in progress — see [GH-2012](https://github.com/qf-studio/pilot/issues/2012).
</Callout>
...
<Callout type="info">
Temporal relevance scoring is in progress — see [GH-2013](https://github.com/qf-studio/pilot/issues/2013).
</Callout>
