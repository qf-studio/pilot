...
Pilot's built-in context engine reduces token usage by 92% while following your architecture, patterns, and conventions. Strategic documentation loading gives Pilot deep codebase understanding — not generic code generation. [Read the Navigator docs →](/navigator)
...
| **Epic Decomposition** | Complex tickets automatically split into subtasks ([see Epic Decomposition docs](/features/epic-decomposition)) |
