...
Without Navigator, Pilot would be another Claude Code wrapper. [Navigator](/navigator) gives Pilot deep codebase understanding through strategic documentation loading — reducing token usage by 92% while following your established patterns, SOPs, and conventions.
...
| Feature | Description |
|---------|-------------|
| **Multi-Platform** | GitHub, GitLab, Linear, Jira, Asana, Azure DevOps |
